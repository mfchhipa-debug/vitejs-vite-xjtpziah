...
export default function AddFamilyHead() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('परिवार मुखिया सफलतापूर्वक जुड़ गया!');
  ...
  return (
    <div style={{ padding: '20px', border: '2px solid #007bff', borderRadius: '8px', marginBottom: '20px' }}>
      <h3>1. नया परिवार जोड़ें (मुखिया)</h3>
      <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '10px' }}>
        ...
        <button type="submit" style={{ padding: '10px', background: '#007bff', color: 'white' }}>परिवार रजिस्टर करें</button>
      </form>
    </div>
  );
}
